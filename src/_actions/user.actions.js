...
function update_user(user){
    ...
    function request(user) { return { type: userConstants.UPDATEUSER_REQUEST, payload: user} }
    function success(user) { return { type: userConstants.UPDATEUSER_SUCCESS, payload: user} }
